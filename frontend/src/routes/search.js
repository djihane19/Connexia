...
import { Flex, Heading, VStack,Text, Button, HStack,Input, Box, Image } from "@chakra-ui/react";
...
const UserProfile = ({username, profile_image, first_name, last_name}) => {
  ...
  return(
    <Flex onClick={handleNav} w='100%' h='100px' gap='30px' border='1px solid' borderColor='gray.300' borderRadius='8px' bg='white'  justifyContent='center' alignItems='center' >
